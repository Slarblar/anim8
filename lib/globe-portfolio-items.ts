...
export const GLOBE_PORTFOLIO_ITEMS: GlobePortfolioItem[] = [
  ...
  { format: 'portrait',  label: 'SAO HOUSE',   title: 'Character Design',        accent: '#7cc142', style: 0, gumletId: '6a5f29e2e4e7b5ab468fdf73', gumletEmbedQuery: 'background=false&autoplay=false&loop=false&disable_player_controls=false', desc: 'Character design for the Sao House universe — concept, sculpt, and production 3D built in-house from first sketch through final asset.' },
  ...
  { format: 'portrait',  label: 'SOCIAL CONTENT', title: 'Sao House',            accent: '#7cc142', style: 3, gumletId: '6a5f2830a151fd5218570084', gumletEmbedQuery: 'background=false&autoplay=false&loop=false&disable_player_controls=false', desc: 'Vertical social content for the Sao House universe — character animation and world-building built natively for the feed.' },
