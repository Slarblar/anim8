...
export const crewT: Record<CrewLang, CrewTranslations> = {
  en: {
    ...
    dashboard: {
      ...
      past3MonthsPerformance: 'Past 3 months + current',
    ...
    kpiPage: {
      ...
      past3Months: 'Past 3 months + current',
      past3MonthsSub: 'Total KPI score by month — last 3 months and this month.',
  ...
  vn: {
    ...
    dashboard: {
      ...
      past3MonthsPerformance: '3 tháng qua + tháng hiện tại',
    ...
    kpiPage: {
      ...
      past3Months: '3 tháng qua + tháng hiện tại',
      past3MonthsSub: 'Tổng điểm KPI theo tháng — 3 tháng trước và tháng này.',
