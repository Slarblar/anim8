...
const ITEMS: GlobeItem[] = [
  ...
  { format: 'landscape', label: 'GALA GAMES',  title: 'Superior Trailer', accent: '#e8b84a', style: 2, gumletId: '69c4ef26123b739cbbcb723a', gumletEmbedQuery: 'background=false&autoplay=false&loop=false&disable_player_controls=false', desc: 'Creative direction on Gala Games\' Superior trailer from our founder\'s prior studio — he brought Gala in, directed the cinematic, and cut the trailer using their production assets.' },
