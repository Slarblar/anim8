  ...
  en: {
    ...
    about: {
      ...
      benefits: {
        label: 'Benefits',
        items: [
          { title: 'Performance Bonuses', desc: 'Project-based and performance bonuses on top of base salary.', highlight: true },
          { title: 'Equipment & Software', desc: 'Hardware and software support as needed, including high-end tools and graphics tablets.' },
          { title: 'U.S. Client Exposure', desc: 'Work directly with U.S. directors and creative leadership on global projects.' },
          { title: 'Training & Growth', desc: 'Training course support and professional development budget included.' },
          { title: 'Leave & Holidays', desc: 'Public holiday / Tet leave, team trips, and team-building per Vietnamese regulations.' },
          { title: 'Creative Culture', desc: 'A professional environment built on respect, creativity, and lifelong learning.' },
        ],
      },
    },
  ...
  vn: {
    ...
    about: {
      ...
      benefits: {
        label: 'Quyền Lợi',
        items: [
          { title: 'Thưởng Hiệu Suất', desc: 'Thưởng theo dự án và hiệu suất ngoài lương cơ bản.', highlight: true },
          { title: 'Thiết Bị & Phần Mềm', desc: 'Hỗ trợ phần cứng và phần mềm theo nhu cầu, bao gồm công cụ cao cấp và máy tính bảng đồ họa.' },
          { title: 'Tiếp Cận Khách Hàng Hoa Kỳ', desc: 'Làm việc trực tiếp với đạo diễn và lãnh đạo sáng tạo Hoa Kỳ trong các dự án toàn cầu.' },
          { title: 'Đào Tạo & Phát Triển', desc: 'Hỗ trợ chi phí khóa đào tạo và ngân sách phát triển nghề nghiệp.' },
          { title: 'Nghỉ Phép & Lễ Tết', desc: 'Nghỉ lễ / Tết, team trip và team building theo quy định Việt Nam.' },
          { title: 'Văn Hóa Sáng Tạo', desc: 'Môi trường chuyên nghiệp được xây dựng trên sự tôn trọng, sáng tạo và học hỏi suốt đời.' },
        ],
      },
    },
