...
const ITEMS: GlobeItem[] = [
  ...
  { format: 'landscape', label: 'GALA GAMES',  title: 'Superior Trailer', accent: '#e8b84a', style: 2, gumletId: '69c4ef26123b739cbbcb723a', gumletEmbedQuery: 'background=false&autoplay=false&loop=false&disable_player_controls=false', desc: 'Creative direction for Gala Games — Superior trailer. We shaped the cut, tone, and visual storytelling for a flagship beat built to sell the fantasy at pitch and launch.' },
