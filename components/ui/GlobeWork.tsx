...
const ITEMS: GlobeItem[] = [
  ...
  { format: 'landscape', label: 'PHIN',        title: 'Character Design & Beauty Render', accent: '#4ec94e', style: 2, galleryImages: ['/brand-style-guide.jpg'], desc: 'Original IP — Phin from sculpt through hero beauty renders. Character design, look development, and production stills built in-house for portfolio and social-first storytelling.' },
  ...
  { format: 'landscape', label: 'IP DESIGN',   title: 'World Building',          accent: '#7cc142', style: 1, desc: 'Fictional universes with depth — secondary characters, environments, lore systems, and platform-native content.' },
